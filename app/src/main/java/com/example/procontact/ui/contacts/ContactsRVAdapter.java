...
class ContactRVAdapter extends RecyclerView.Adapter<ContactRVAdapter.ViewHolder> {
    ...
    public ContactRVAdapter(Context context, ArrayList<ContactsModal> contactsModalArrayList, OnNoteListener onNoteListener) {
    ...
    public ContactRVAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ContactRVAdapter.ViewHolder(LayoutInflater.from(context).inflate(R.layout.contacts_rv_item, parent, false),mOnNoteListener);
    }
